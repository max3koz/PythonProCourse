...
"""
Питання 1: Що відбувається, коли локальна функція має те саме ім'я, що й вбудована?
Відповідь: Локальна функція перекриває вбудовану функцію. Таким чином при виклику
           функції з ім'ям вбудованої функції після її перевизначення буде виконуватись
           алгоритм, який реалізований у локальній функції. Вбудована функция
           викликатися не буде.
           
Питання 2: Як можна отримати доступ до вбудованої функції, навіть якщо вона перекрита?
Відповідь: Існує декілька варіантів:
	      1. зберігти оригінал вбудованої функції, до реалізації перекриття.
	      2. Використати пакет buildins, наприклад:
	         import buildins
	         builtins.sum([5, 2, 4])
"""
